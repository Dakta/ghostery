...
require([
...
], function ($, _, Backbone, i18n, browser, options_tpl, moment) {
	...
	function get() {
		...
		conf.show_contextual_menu_items =
			$('#show_contextual_menu_items')[0].checked;
	...
	function loadOptions(bp) {
		...
		$('#contextual-menu-help').tipTip({
			content: '<img src="data/images/help/contextual_menu.png" alt="">',
			maxWidth: '300px'
		});
	...
	safari.self.addEventListener('message', function (e) {
		...
		if (e.name == 'optionsBugListUpdated') {
			if (!msg.success) {
			...
			$('#content').html(
				options_tpl({
					button_present: msg.button_present,
					conf: msg.conf,
