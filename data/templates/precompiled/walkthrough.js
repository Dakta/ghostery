...
((__t=( t('welcome_to_ghostery', 'Safari', '<span id="version-text"></span>') ))==null?'':__t)+
'\n\t\t</p>\n\t\t<p>\n\t\t\t'+
((__t=( t('walkthrough_intro1') ))==null?'':_.escape(__t))+
'\n\t\t</p>\n\t\t<p>\n\t\t\t'+
((__t=( t('walkthrough_intro2') ))==null?'':__t)+
'\n\t\t</p>\n\t</div>\n\n\t<div style="display:none" class="options-div">\n\t\t<p>\n\t\t\t'+
((__t=( t('walkthrough_safari_updates_desc') ))==null?'':_.escape(__t))+
'\n\t\t\t<ol>\n\t\t\t\t<li>'+
((__t=( t('walkthrough_safari_updates1') ))==null?'':_.escape(__t))+
'</li>\n\t\t\t\t<li>'+
((__t=( t('walkthrough_safari_updates2') ))==null?'':_.escape(__t))+
'</li>\n\t\t\t\t<li>'+
((__t=( t('walkthrough_safari_updates3') ))==null?'':_.escape(__t))+
'</li>\n\t\t\t\t<li>'+
((__t=( t('walkthrough_safari_updates4') ))==null?'':_.escape(__t))+
'</li>\n\t\t\t</ol>\n\t\t\t<img src="data/images/help/autoupdates.png" title="'+
((__t=( t("walkthrough_safari_updates_screenshot_title") ))==null?'':_.escape(__t))+
'" style="margin-left: -40px;">\n\t\t\t<br>\n\t\t\t'+
((__t=( t('walkthrough_safari_updates_desc2') ))==null?'':_.escape(__t))+
'\n\t\t</p>\n\t</div>\n\n\t<div style="display:none" class="options-div">\n\t\t<p>\n\t\t\t'+
((__t=( t('walkthrough_sharing_desc') ))==null?'':_.escape(__t))+
'\n\t\t</p>\n\n\t\t<hr>\n\n\t\t'+
