...
'\n\t\t\t\t</p>\n\n\t\t\t\t<p>\n\t\t\t\t\t';
 if (!button_present) { 
__p+='\n\t\t\t\t\t<div id="button-notification-message">\n\t\t\t\t\t\t'+
((__t=( t('safari_removed_button_note') ))==null?'':_.escape(__t))+
'\n\t\t\t\t\t</div>\n\t\t\t\t\t';
 } 
__p+='\n\t\t\t\t\t<input type="checkbox" id="show-badge"\n\t\t\t\t\t\t';
 if (conf.show_badge) print(' checked') 
__p+='\n\t\t\t\t\t\t';
 if (!button_present) print(' disabled') 
__p+='>\n\t\t\t\t\t<label for="show-badge"';
 if (!button_present) print(' style="color:gray"') 
__p+='>'+
((__t=( t('options_badge') ))==null?'':__t)+
'</label>\n\t\t\t\t</p>\n\t\t\t\t<p>\n\t\t\t\t\t<input type="checkbox" id="show_contextual_menu_items"';
 if (conf.show_contextual_menu_items) print(' checked') 
__p+='>\n\t\t\t\t\t<label for="show_contextual_menu_items">'+
((__t=( t('options_rightclick_menu_safari') ))==null?'':__t)+
'</label>\n\t\t\t\t</p>\n\t\t\t</td>\n\t\t</tr>\n\n \t\t<tr>\n \t\t\t<th>\n\t\t\t\t'+
((__t=( t("options_blocking_header") ))==null?'':_.escape(__t))+
...
((__t=( t("help_version_text", "Safari", ghostery_version) ))==null?'':_.escape(__t))+
'</h1>\n\t\t<p>\n\t\t\t'+
